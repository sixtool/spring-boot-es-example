 ...
 * QueryBuilders.termsQuery("", ""); // in
 * QueryBuilders.boolQuery(); // must: and, mustNot: not, should: or
 * QueryBuilders.rangeQuery(""); // between...and...
 * QueryBuilders.existsQuery(""); // field is not null
